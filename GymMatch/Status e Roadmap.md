...
- [x] Perfil (`/me`): redesign v4 — header h-44 com gradiente, profile card flutuante (-mt-8) com avatar+nome+botões, tabs com pill seletor, grid de fotos interativo com popup Câmera/Galeria
